package com.sanswich.rpgaspects.entity.model;
...
public class ModelHardCreeper extends ModelBase
	{
	    ...
	    public ModelHardCreeper()
	    {
	        this(0.0F);
	    }

	    public ModelHardCreeper(float p_i46366_1_)
	    {
	        int i = 6;
